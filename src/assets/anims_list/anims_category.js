 ...
 * 소년만화 원작의 작품이나, 액션과 모험이 중심이 되는 애니메이션들입니다.
 */
const anims_action_adventure = [
    {
        name: "원피스",
        ...
        pv: 'https://www.youtube.com/embed/fX9NK_YqlI?si=DJjhGVH9pxdWIfta'
    },
    {
        name: "나루토",
    ...
    },
    {
        ...
        pv: 'https://www.youtube.com/embed/eYXNyaaplsI?si=_EAauTTYdSIBD47_'
    },
    {
        name: "단다단",
...
/**
 * 장르: 이세계/판타지 (Isekai/Fantasy)
 * 주인공이 다른 세계로 이동하거나, 마법 등 판타지 요소가 중심이 되는 애니메이션들입니다.
 */
const anims_isekai_fantasy = [
    {
        name: "장송의 프리렌",
    ...
    },
    {
        ...
        pv: 'https://www.youtube.com/embed/2ei4KpfCOAI?si=OFk3QCzVjEiGkuDl'
    },
    {
        name: "지박소년 하나코 군",
        ...
        pv: 'https://www.youtube.com/embed/U-bi92K4mPg?si=NG_S0ZQ9qMUqjG6y'
    },
    {
        name: "이세계 유유자적 농가",
        ...
        pv: 'https://www.youtube.com/embed/34MhY35eye4?si=_oilJy9vVSxdMEYu'
    },
    {
    ...
    },
    {
        ...
        pv: 'https://www.youtube.com/embed/cmtBH_ttUYQ?si=_fZEdk4ZXmwH262Q'
    }
];

/**
 * 장르: 로맨스/코미디 (Romance/Comedy)
 * 인물 간의 연애 감정이나 코믹한 상황이 중심이 되는 애니메이션들입니다.
 */
const anims_romance_comedy = [
    {
        ...
        pv: 'https://www.youtube.com/embed/HahiyJl4Hto?si=uU5F9X-sp_RhSlub'
    },
    {
        name: "유사 하렘",
        ...
        pv: 'https://www.youtube.com/embed/LcWOmT3mnTE?si=Aa3zOvU92pkj25o3'
    },
    {
        ...
        pv: 'https://www.youtube.com/embed/oGLjtxmmDI4?si=2zMUxUmwSKVpAuPT'
    },
    {
        name: "사랑은 세계정복 후에",
        ...
        pv: 'https://www.youtube.com/embed/zc8NrpnZEdA?si=NXWdPxzBxVqDe2bv'
    },
    {
        ...
        pv: 'https://www.youtube.com/embed/aDU9iq3zuvs?si=yWAWlCJkRy4saEuj'
    },
    {
        name: "카구야님은 고백받고 싶어",
        ...
        pv: 'https://www.youtube.com/embed/qrprFjpXfR0?si=AZuB_cXBTHoE66xq'
    },
    {
        name: "내 마음의 위험한 녀석",
        ...
        pv: 'https://www.youtube.com/embed/HVLrlrGT2aI?si=_VYBQdYYKMcbN410'
    },
    {
        name: "당신은 저승님.",
        ...
        pv: 'https://www.youtube.com/embed/ZacOQVZrrU0?si=Z4w6s6c5riUaakWN'
    },
    {
        name: "장난을 잘 치는 타카기 양",
        ...
        pv: 'https://www.youtube.com/embed/ROrZpPROhrA?si=q_2HU3d3hFVDCS2o'
    },
    {
        name: "토라도라!",
        ...
        pv: 'https://www.youtube.com/embed/72imld-Zkck?si=kPm134b1E_3B-8zO'
    },
    {
        ...
        pv: 'https://www.youtube.com/embed/2la4-YHtkis?si=b0LZmzstLp9sf_YI'
    },
    {
        ...
        pv: 'https://www.youtube.com/embed/1_EA91OW9tc?si=UY4h3e8a3CQy6ZFm'
    },
    {
        ...
        pv: 'https://www.youtube.com/embed/LVXDGqMQHyE?si=0fh0dx-u9UOgdIr1'
    },
    {
        name: "아하렌 양은 알 수가 없어",
        ...
        pv: 'https://www.youtube.com/embed/dC3ZsTjdiD0?si=K6C0s8nVjHoAnZr1'
    },
    {
        ...
        pv: 'https://www.youtube.com/embed/s1GZA4w7slM?si=84LgFdY-G1A4rtu8'
    },
    {
        name: "철야의 노래",
        ...
        pv: 'https://www.youtube.com/embed/M0NPwHnVkXk?si=LOa2PNIRbFAFIKUL'
    },
    {
        name: "쿠보 양은 나를 내버려두지 않아",
        path: `${process.env.PUBLIC_URL}/imgs/anim_imgs/kubosan.png`,
    ...
    },
    {
        ...
        pv: 'https://www.youtube.com/embed/s48x7R_mptY?si=Kldp0PyVvyGirlH0'
    }
];

/**
 * 장르: 드라마/SF (Drama/Sci-Fi)
 * 진지하고 무거운 서사나, 과학적 상상력을 기반으로 한 애니메이션들입니다.
 */
const anims_drama_sf = [
    {
        name: "진격의 거인",
    ...
    {
        name: "86 -에이티식스-",
        path: `${process.env.PUBLIC_URL}/imgs/anim_imgs/eightysix.png`,
        plot: "인간이 탑승하지 않는 무인 전투기 '레기온'과의 전쟁을 치르는 산마그놀리아 공화국. 하지만 무인기의 정체는 공화국에서 인간 취급 받지 못하는 소년소녀 '86(에이티식스)'들이었다. 핸들러인 소령 블라디레나 밀리제와 86 부대의 대장 신에이 노우젠을 중심으로, 차별과 멸시 속에서 죽어가는 소년병들의 처절한 사투를 그린 전쟁 드라마.",
        barrier: "인종차별, 소년병, 전쟁의 참상 등 매우 무겁고 어두운 주제를 다루기 때문에 시청 시 정신적인 피로감이 클 수 있다. 또한, 정치 및 군사 관련 설정이 다소 복잡하게 느껴질 수 있다.",
        pv: 'https://www.youtube.com/embed/9MjOvXoFjoo?si=Bh47_ehpcMn1mMu6'
    },
    {
        name: "사이버펑크: 엣지러너",
...
/**
 * 장르: 일상/장수 시리즈 (Slice of Life / Long-Running)
 * 에피소드 중심으로 가볍게 즐길 수 있거나, 매우 오랜 기간 방영된 애니메이션들입니다.
 */
const anims_daily_longrun = [
    {
        name: "짱구",
