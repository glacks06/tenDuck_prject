...
const anims_1000m = [
    ...
    },
    {
        ...
        barrier: "주인공의 중2병 설정과 착각물 개그 코드가 취향에 맞지 않으면 유치하게 느껴질 수 있다."
    },
    {
    ...
    },
    {
        ...
        barrier: "전형적인 하렘 먼치킨 장르로, 기존의 유사 작품들과 차별점을 찾기 어려울 수 있다."
    },
    {
    ...
    },
    {
        ...
        barrier: "양자역학 등 과학 이론을 섞은 설정이 다소 난해하고, 대화의 비중이 높아 집중력이 필요하다."
    },
    {
        ...
        barrier: "하나의 핵심 설정(러시아어 고백)에 크게 의존하는 단순한 구조의 로맨틱 코미디이다."
    }
];
...
const anims_1500m = [
    {
        ...
        barrier: "주인공이 어린아이의 모습으로 등장하지만 행동이나 생각이 성인에 가까워 위화감을 느낄 수 있으며, 다소 선정적인 장면이 포함된다."
    },
    {
        ...
        barrier: "하렘 장르를 극단적으로 비튼 패러디물으로, 비현실적이고 정신없는 전개가 취향에 맞지 않을 수 있다."
    }
];
